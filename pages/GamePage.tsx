  ...
  if (!gameId || !gameComponentMap[gameId] || !currentGameInfo) {
    return (
      <Card className="text-center">
        <h2 className="text-2xl font-bold text-red-500 mb-4">Игра не найдена</h2>
        <p className="text-scrazino-gray-600 dark:text-scrazino-gray-300 mb-6">
  ...
  return (
    <div className="space-y-6">
      <header className="text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-scrazino-gray-800 dark:text-scrazino-gray-100 mb-2">
          {currentGameInfo.name}
        </h1>
        <p className="text-md sm:text-lg text-scrazino-gray-600 dark:text-scrazino-gray-400 max-w-2xl mx-auto">
          {currentGameInfo.description}
        </p>
         {currentGameInfo.rules && (
           <details className="mt-4 text-sm text-scrazino-gray-500 dark:text-scrazino-gray-400 bg-scrazino-gray-50 dark:bg-scrazino-gray-800 p-3 rounded-lg shadow-inner max-w-xl mx-auto">
